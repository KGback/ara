...
module vmfpu import ara_pkg::*; import rvv_pkg::*; import fpnew_pkg::*;
  import cf_math_pkg::idx_width; import ifmix_pkg::*;#(
  ...
  // gukai@20250302
  assign vinsn_issue_mul = vinsn_issue_q.op inside {[VMUL:VIFMM]};  // VSMUL
  ...
  // gukai@20250302
  assign clkgate_en_d = vinsn_processing_d_valid & (vinsn_processing_d.op inside {[VMUL:VIFMM]}); // VSMUL
...
*/
  ...
  always_comb begin: p_vmfpu
    ...
    vmul_out_ready = ~result_queue_full && (vinsn_processing_q.op inside {[VMUL:VIFMM]});  // gukai@20250302 VSMUL
    ...
    case (mfpu_state_q)
      NO_REDUCTION: begin
        ...
        case (vinsn_processing_q.op) inside
          [VMUL:VIFMM]: begin  // gukai@20250302  VSMUL
