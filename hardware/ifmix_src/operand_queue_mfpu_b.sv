module operand_queue_mfpu_b import ara_pkg::*; import rvv_pkg::*; import cf_math_pkg::idx_width;import ifmix_pkg::*; #(
  ...
  always_comb begin: obuf_control
    ...
    if (operand_valid_o && |operand_ready_i) begin
      ...
      unique case (cmd.conv)
        ...
        OpQueueConversionFPINT: begin   // gukai@20250218
          // From 8/4 operands to 2 operands
          // if (transfer_pack_i.transfer_type) begin
...
endmodule : operand_queue_mfpu_b
