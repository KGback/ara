...
add wave -noupdate -expand -group LANE1 -expand -group OLR_JUDGE {/ara_tb/dut/i_ara_soc/i_system/i_ara/gen_lanes[1]/i_lane/i_operand_queues/i_outlier_judge/operand_eew_a}
add wave -noupdate -expand -group LANE1 -expand -group OLR_JUDGE {/ara_tb/dut/i_ara_soc/i_system/i_ara/gen_lanes[1]/i_lane/i_operand_queues/i_outlier_judge/operand_eew_b}
add wave -noupdate -expand -group LANE1 -expand -group OLR_JUDGE {/ara_tb/dut/i_ara_soc/i_system/i_ara/gen_lanes[1]/i_lane/i_operand_queues/i_outlier_judge/full_m_fp32}
add wave -noupdate -expand -group LANE1 -expand -group OLR_JUDGE {/ara_tb/dut/i_ara_soc/i_system/i_ara/gen_lanes[1]/i_lane/i_operand_queues/i_outlier_judge/op0_diff_e_fp32}
add wave -noupdate -expand -group LANE1 -expand -group OLR_JUDGE {/ara_tb/dut/i_ara_soc/i_system/i_ara/gen_lanes[1]/i_lane/i_operand_queues/i_outlier_judge/op1_diff_e_fp32}
add wave -noupdate -expand -group LANE1 -expand -group OLR_JUDGE {/ara_tb/dut/i_ara_soc/i_system/i_ara/gen_lanes[1]/i_lane/i_operand_queues/i_outlier_judge/olr_thd_dynamic_d}
add wave -noupdate -expand -group LANE1 -expand -group OLR_JUDGE {/ara_tb/dut/i_ara_soc/i_system/i_ara/gen_lanes[1]/i_lane/i_operand_queues/i_outlier_judge/olr_thd_dynamic_q}
add wave -noupdate -expand -group LANE1 -expand -group OLR_JUDGE {/ara_tb/dut/i_ara_soc/i_system/i_ara/gen_lanes[1]/i_lane/i_operand_queues/i_outlier_judge/max_int_fp32}
add wave -noupdate -expand -group LANE1 -expand -group OLR_JUDGE {/ara_tb/dut/i_ara_soc/i_system/i_ara/gen_lanes[1]/i_lane/i_operand_queues/i_outlier_judge/scaling_factor}
add wave -noupdate -expand -group LANE1 -expand -group OLR_JUDGE {/ara_tb/dut/i_ara_soc/i_system/i_ara/gen_lanes[1]/i_lane/i_operand_queues/i_outlier_judge/transfer_pack_o}
...
add wave -noupdate -expand -group LANE1 -expand -group operand_queue_mfpu_a {/ara_tb/dut/i_ara_soc/i_system/i_ara/gen_lanes[1]/i_lane/i_operand_queues/i_operand_queue_mfpu_a/transfer_pack_i}
...
add wave -noupdate -expand -group LANE1 -expand -group operand_queue_mfpu_a {/ara_tb/dut/i_ara_soc/i_system/i_ara/gen_lanes[1]/i_lane/i_operand_queues/i_operand_queue_mfpu_a/transfer_pack}
...
add wave -noupdate -expand -group LANE1 -expand -group operand_queue_mfpu_a {/ara_tb/dut/i_ara_soc/i_system/i_ara/gen_lanes[1]/i_lane/i_operand_queues/i_operand_queue_mfpu_a/transfer_pack_o}
...
WaveRestoreCursors {{Cursor 1} {3315499 ps} 0} {{Cursor 2} {3352491 ps} 0}
...
update
WaveRestoreZoom {3315273 ps} {3319624 ps}
