...
w_loc   = 0  # 原始均值
w_scale = 1  # 标准差
truncated_norm = truncnorm(w_min, w_max, w_loc, w_scale)
W = truncated_norm.rvs(VEC_SIZE)
...
emit("w", W, 'NR_LANES*4')
emit("qw", QW, 'NR_LANES*1')
emit("x", B, 'NR_LANES*4')
emit("scale", scale, 'NR_LANES*4')
