...
function automatic logic [31:0] fp32_to_int32_compensate(ara_pkg::fp32_t fp32, logic [7:0] fp32_exponent);
    ...
    int32[31] = fp32.s;
     ...
     if (fp32_exponent > fp32.e) begin  // right shift

          diff_e_fp32 = fp32_exponent - fp32.e;
          case (diff_e_fp32)
               8'd0:    int32[30:0] =  { 7'b0,         full_m_fp32[23:0]};
               8'd1:    int32[30:0] =  { 7'b0, 1'b0,   full_m_fp32[23:1]};
               8'd2:    int32[30:0] =  { 7'b0, 2'b0,   full_m_fp32[23:2]};
               8'd3:    int32[30:0] =  { 7'b0, 3'b0,   full_m_fp32[23:3]}; 
               8'd4:    int32[30:0] =  { 7'b0, 4'b0,   full_m_fp32[23:4]};
               8'd5:    int32[30:0] =  { 7'b0, 5'b0,   full_m_fp32[23:5]};
               8'd6:    int32[30:0] =  { 7'b0, 6'b0,   full_m_fp32[23:6]};
               8'd7:    int32[30:0] =  { 7'b0, 7'b0,   full_m_fp32[23:7]};
               8'd8:    int32[30:0] =  { 7'b0, 8'b0,   full_m_fp32[23:8]};
               8'd9:    int32[30:0] =  { 7'b0, 9'b0,   full_m_fp32[23:9]};
               8'd10:   int32[30:0] =  { 7'b0, 10'b0,  full_m_fp32[23:10]};
               8'd11:   int32[30:0] =  { 7'b0, 11'b0,  full_m_fp32[23:11]};
               8'd12:   int32[30:0] =  { 7'b0, 12'b0,  full_m_fp32[23:12]};
               8'd13:   int32[30:0] =  { 7'b0, 13'b0,  full_m_fp32[23:13]};
               8'd14:   int32[30:0] =  { 7'b0, 14'b0,  full_m_fp32[23:14]};
               8'd15:   int32[30:0] =  { 7'b0, 15'b0,  full_m_fp32[23:15]};
               8'd16:   int32[30:0] =  { 7'b0, 16'b0,  full_m_fp32[23:16]};
               8'd17:   int32[30:0] =  { 7'b0, 17'b0,  full_m_fp32[23:17]};
               8'd18:   int32[30:0] =  { 7'b0, 18'b0,  full_m_fp32[23:18]};
               8'd19:   int32[30:0] =  { 7'b0, 19'b0,  full_m_fp32[23:19]};
               8'd20:   int32[30:0] =  { 7'b0, 20'b0,  full_m_fp32[23:20]};
               8'd21:   int32[30:0] =  { 7'b0, 21'b0,  full_m_fp32[23:21]};
               8'd22:   int32[30:0] =  { 7'b0, 22'b0,  full_m_fp32[23:22]};
               8'd23:   int32[30:0] =  { 7'b0, 23'b0,  full_m_fp32[23]};
               default: int32[30:0] =  '0;
          endcase
     end else begin                     // left shift
          diff_e_fp32 = fp32.e - fp32_exponent;
          int32[30:0] =  { 7'b0, full_m_fp32[23:0]};
     end
    ...
    if (fp32.e == 8'd0) begin
        ...
        fp32_to_int8_quantize  = 8'h0;
          ...
          if (fp32.e > 8'd127) begin // left shift
               ...
               case (diff_e_fp32)
                    8'd0: int_val = {int_val_tmp[30:23]};  // only need integer part
                    8'd1: int_val = {int_val_tmp[29:23], 1'b0};
                    8'd2: int_val = {int_val_tmp[28:23], 2'b0};
                    8'd3: int_val = {int_val_tmp[27:23], 3'b0};
                    8'd4: int_val = {int_val_tmp[26:23], 4'b0};
                    8'd5: int_val = {int_val_tmp[25:23], 5'b0};
                    8'd6: int_val = {int_val_tmp[24:23], 6'b0};
                    8'd7: int_val = {int_val_tmp[23], 7'b0};
               ...
               case (diff_e_fp32)
                    8'd0: int_val = int_val_tmp[30:23];  // only need integer part
                    8'd1: int_val = {1'b0, int_val_tmp[30:24]};
                    8'd2: int_val = {2'b0, int_val_tmp[30:25]};
                    8'd3: int_val = {3'b0, int_val_tmp[30:26]};
                    8'd4: int_val = {4'b0, int_val_tmp[30:27]};
                    8'd5: int_val = {5'b0, int_val_tmp[30:28]};
                    8'd6: int_val = {6'b0, int_val_tmp[30:29]};
                    8'd7: int_val = {7'b0, int_val_tmp[30]};
...
function automatic ara_pkg::fp32_t int8_to_fp32_dequantize(logic [31:0] int32,logic [7:0] scaling_factor);
    automatic logic [30:0] int32_deq;
    automatic logic [30:0] int32_tmp;
    ...
    int32_deq[30:0]  = int32_tmp[30:0] * full_m_scaling_factor_recpi; 

     int8_to_fp32_dequantize.s = int32[31];

     unique casex ({int32[31], int32_deq[30:0]})
        32'b11??????_????????_????????_????????: begin
    ...
    endcase
     ...
     `ifdef TARGET_SIMULATION
          $display("int32: %h, int32_deq: %h, int8_to_fp32_dequantize: %h",int32, int32_deq, int8_to_fp32_dequantize); 
